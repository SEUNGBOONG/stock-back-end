...
@Getter
public enum PortfolioDescription {
    ...
    RANGE_2000_3000_NORMAL("연봉 2000-3000: 안정적인 성장을 목표로 주식과 채권에 균형 있게 투자하며, 저축으로 비상자금을 마련합니다."),
    RANGE_3000_4000_NORMAL("연봉 3000-4000: 주식과 채권을 적절히 혼합하여 위험을 관리하며, 저축을 통해 안정성을 확보합니다."),
    RANGE_4000_5000_NORMAL("연봉 4000-5000: 주식 비중을 다소 높이고 채권과 저축으로 리스크를 분산하여 성장과 안정의 균형을 유지합니다."),
    RANGE_5000_6000_NORMAL("연봉 5000-6000: 안정적인 성장을 목표로 주식, 채권, 저축에 고르게 투자하여 균형 잡힌 포트폴리오를 구성합니다."),
    RANGE_6000_7000_NORMAL("연봉 6000-7000: 주식과 채권 비중을 균형 있게 유지하며, 저축으로 비상자금을 마련하여 안정성을 강화합니다."),
    RANGE_7000_8000_NORMAL("연봉 7000-8000: 주식과 채권에 고르게 투자하며 안정적인 성장과 자산 증식을 동시에 추구합니다."),
    RANGE_8000_9000_NORMAL("연봉 8000-9000: 주식, 채권, 저축을 조화롭게 구성하여 안정적인 장기 성장을 지향합니다."),
    RANGE_9000_10000_NORMAL("연봉 9000-10000: 위험과 수익의 균형을 고려하여 주식, 채권, 저축에 고르게 투자하며, 안정적 자산 증식을 목표로 합니다.");

    private final String description;

    PortfolioDescription(String description) {
